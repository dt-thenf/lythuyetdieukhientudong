...
\textbf{Ghi chú.} Cuối tài liệu bắt đầu mục \(3.2\) về graph tín hiệu; phần được cung cấp mới nêu khái niệm điểm nút và các loại điểm, chưa có một bài giải hoàn chỉnh để bổ sung thành bài tập mới.
